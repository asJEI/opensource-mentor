    ...
    <section className="hero" id="hero">
      ...
      <div className="hero-content">
        ...
        <h1>
          让开源贡献
          <br />
          变得<span style={{ background: 'var(--gradient)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>简单又有趣</span>
        </h1>
        ...
        <div className="hero-preview">
          <div className="hero-preview-frame">
            <div className="hero-preview-header">
              ...
              <div className="hero-preview-url">opensource-mentor.app/dashboard</div>
            </div>
  ...
  return (
    <AnimatedSection id="preview" className="alt">
      ...
      <div className="preview-content">
        {/* 仓库分析面板 */}
        <div className={clsx('preview-panel', activeTab === 'repo' && 'active')}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: '24px' }}>
              ...
              <div>
                <div className="ai-summary-text">
                  <strong>AI 摘要：</strong> VS Code 是微软推出的开源代码编辑器，基于 Electron 框架构建，采用 TypeScript 开发。项目架构清晰，核心模块包括编辑器核心、扩展系统、终端集成等。整体难度中等，适合有前端基础的开发者参与。
                </div>
                <div className="ai-metrics-row">
                  <div className="ai-metric">
                    <div className="ai-metric-label">项目难度</div>
                    <div className="ai-metric-value" style={{ color: 'var(--yellow)' }}>中等</div>
                  </div>
                  <div className="ai-metric">
                    <div className="ai-metric-label">新手友好</div>
                    <div className="ai-metric-value" style={{ color: 'var(--green)' }}>是</div>
                  </div>
                  <div className="ai-metric">
                    <div className="ai-metric-label">推荐 Issue</div>
                    <div className="ai-metric-value" style={{ color: 'var(--accent)' }}>126 个</div>
                  </div>
                </div>
                <div style={{ marginBottom: '12px', fontSize: '14px', fontWeight: '600' }}>推荐入门 Issue</div>
                <div className="suggested-issues-list">
                  <div className="suggested-issue">
                    <div className="suggested-issue-icon">
                      <CheckIcon />
                    </div>
                    <span className="suggested-issue-text">fix: 修复编辑器中光标位置计算错误的问题</span>
                  </div>
                  <div className="suggested-issue">
                    <div className="suggested-issue-icon">
                      <CheckIcon />
                    </div>
                    <span className="suggested-issue-text">docs: 更新中文翻译文档中的术语不一致</span>
                  </div>
                  <div className="suggested-issue">
                    <div className="suggested-issue-icon">
                      <CheckIcon />
                    </div>
                    <span className="suggested-issue-text">feat: 为终端添加自定义背景色支持</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Issue 推荐面板 */}
        <div className={clsx('preview-panel', activeTab === 'issues' && 'active')}>
          <div className="preview-panel-inner">
            ...
            <div className="issues-list">
              {[
                { title: 'fix: 修复搜索高亮在深色主题下不可见的问题', labels: ['bug', 'good-first'], score: 95, difficulty: 'easy' },
                { title: 'feat: 添加对 CSV 文件的语法高亮支持', labels: ['enhancement'], score: 88, difficulty: 'medium' },
                { title: 'docs: 修正 API 文档中参数描述错误', labels: ['docs'], score: 92, difficulty: 'easy' },
              ].map((issue, i) => (
                  ...
                  <div className="issue-main">
                    <div className="issue-title-row">
                      ...
                      {issue.labels.map((label) => (
                        <span key={label} className={clsx('issue-label', label)}>
                          {label}
                        </span>
                      ))}
                    </div>
        ...
        <div className={clsx('preview-panel', activeTab === 'pr' && 'active')}>
          <div className="preview-panel-inner">
            <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: '24px' }}>
              <div>
                <div style={{ fontSize: '14px', fontWeight: '600', marginBottom: '12px' }}>PR 类型</div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ fontSize: '12px', fontWeight: '600', color: 'var(--muted)', marginBottom: '6px' }}>标题</div>
                    <div className="pr-title-display">fix: 修复搜索高亮在深色主题下对比度不足的问题</div>
                  </div>
                  <div style={{ fontSize: '12px', fontWeight: '600', color: 'var(--muted)', marginBottom: '6px' }}>描述</div>
                  <div className="pr-description">
                    <h4>问题描述</h4>
                    <p>在深色主题下，搜索结果的高亮文字与背景对比度不足，导致难以辨认。</p>
                    <h4>解决方案</h4>
                    <ul>
                      <li>调整深色主题下的高亮背景色</li>
                      <li>增加文字颜色对比度</li>
